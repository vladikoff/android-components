...
import mozilla.components.lib.qr.camera.CameraManager;
import mozilla.components.lib.qr.camera.LiveDataProcessingCallback;
import mozilla.components.lib.qr.scanner.decoder.BarcodeDecoder;
import mozilla.components.lib.qr.scanner.decoder.zxing.ZXDecoder;
import mozilla.components.lib.qr.scanner.util.SoundPlayer;
