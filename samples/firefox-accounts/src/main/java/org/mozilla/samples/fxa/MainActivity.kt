...
open class MainActivity : AppCompatActivity(), LoginFragment.OnLoginCompleteListener, QrFragment.OnScanCompleteListener, CoroutineScope {
    ...
    override fun onScanComplete(pairingUrl: String) {
...
//        when (requestCode) {
//            REQUEST_CAMERA_PERMISSIONS -> qrFeature.onPermissionsResult(permissions, grantResults)
//        }
//        qrFeature.onRequestPermissionsResult(requestCode, permissions, grantResults)
//    }
